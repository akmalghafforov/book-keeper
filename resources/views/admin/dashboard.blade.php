...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-[#161615] p-6 rounded-lg border border-gray-200 dark:border-[#3E3E3A] shadow-sm">
        <div class="flex items-center">
            ...
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Open Orders</p>
        ...
        <table class="w-full text-left">
            <thead>
                <tr class="bg-gray-50 dark:bg-[#1C1C1A]">
                    ...
                    <th class="px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">User</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-[#3E3E3A]">
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Created new client</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 py-1 text-xs font-semibold text-green-600 bg-green-100 rounded-full">Success</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Updated product stock</td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 py-1 text-xs font-semibold text-blue-600 bg-blue-100 rounded-full">Info</span>
                    </td>
                </tr>
            </tbody>
        </table>
