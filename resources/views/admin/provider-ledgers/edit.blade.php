...
@section('title', __('Edit Provider Payment'))
@section('header_title', __('Edit Provider Payment'))
...
<div class="max-w-2xl mx-auto space-y-6" x-data="{ providerId: '{{ old('provider_id', $providerLedger->provider_id) }}' }">
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Edit Provider Payment') }}</h2>
