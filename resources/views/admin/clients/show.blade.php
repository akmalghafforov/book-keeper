    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <form action="{{ route('admin.reports.export-client-debt', $client) }}" method="POST" class="inline-block">
                ...
                <button type="submit" class="inline-flex items-center px-3 py-1.5 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-sm" title="{{ __('Export PDF') }}">
