...
@section('title', __('Edit Distribution'))
@section('header_title', __('Edit Distribution'))
...
<div class="max-w-4xl mx-auto space-y-6" x-data="{ 
    ...
    productId: '{{ old('product_id', $distribution->product_id) }}',
    products: {},
    productCategoryId: '{{ old('product_category_id', $distribution->product->product_category_id) }}',
    unit: '{{ old('quantity_unit', $distribution->quantity_unit) }}',
    ...
    syncProduct(preserveProviderPrice = false) {
        ...
        if (product?.default_unit) this.unit = product.default_unit;
