...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Distribution Details') }}</h2>
        ...
        <div class="p-8">
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-8">
                ...
                <div class="sm:col-span-1">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $distribution->quantity }} {{ __($distribution->quantity_unit) }}</dd>
                </div>
                <div class="sm:col-span-1">
