    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <aside
            ...
            <nav class="p-4 space-y-2 overflow-y-auto h-[calc(100vh-4rem)]">
                ...
                <a href="{{ route('admin.reports.client-debt') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.reports.client-debt') ? 'bg-gray-100 dark:bg-[#2A2A28] text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#1C1C1A]' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
